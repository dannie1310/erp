        ...
        <div class="card" >
            <div class="card-body">
                <span>
                    ...
                    @if($token)
                        <br>
                        <a href="https://{{$_SERVER['SERVER_NAME']}}:{{$_SERVER['SERVER_PORT']}}/api/solicitud-pago-anticipado/{{$solicitud->id}}/autorizar-vista?access_token={{$token}}">[AUTORIZAR]</a>
                        <a href="https://{{$_SERVER['SERVER_NAME']}}:{{$_SERVER['SERVER_PORT']}}/api/solicitud-pago-anticipado/{{$solicitud->id}}/pide-motivo-rechazo?access_token={{$token}}">[RECHAZAR]</a>
