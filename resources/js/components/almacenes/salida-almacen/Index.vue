...
<script>
    ...
    export default {
        ...
        methods: {
            paginate() {
                this.cargando = true;
                return this.$store.dispatch('almacenes/salida-almacen/paginate', { params: this.query})
                    .then(data => {
        ...
        computed: {
            salidas() {
                return this.$store.getters['almacenes/salida-almacen/salidas'];
            },
            meta() {
                return this.$store.getters['almacenes/salida-almacen/meta'];
            },
            tbodyStyle() {
