            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle"> <i class="fa fa-th"></i> ELIMINAR AJUSTE DE INVENTARIO</h5>
                                        ...
                                        <div class="table-responsive col-md-12">
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                 ...
                                                 <tr v-if="ajustes.observaciones" class="invoice p-3 mb-3">
                                                        <td colspan="6"><b>Observaciones: </b>{{ajustes.observaciones}}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
