        ...
        <div class="modal fade" ref="modal_datos" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable modal-xl modal" role="document" style="height:auto">
                <div class="modal-content" v-if="datos_archivo">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle2"> <i class="fa fa-close"></i> ERRORES EN LAYOUT EDICIÓN DE SOLICITUD</h5>
    ...
    export default {
        ...
        methods:{
            ...
            cargarLayout(){
                ...
                formData.append('base', atob(this.base));
                return this.$store.dispatch('portalProveedor/solicitud-autorizacion-avance/cargaLayoutEdit',
                    {
                        data: formData,
                        config: {
                            params: { _method: 'POST'}
