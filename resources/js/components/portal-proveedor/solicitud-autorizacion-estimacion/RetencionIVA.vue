...
<script>
    export default {
        ...
        methods: {
            ...
            update(){
                return this.$store.dispatch('portalProveedor/solicitud-autorizacion-avance/registrarRetencionIva', {
                    id: this.id,
                    params:{base: this.base, retencion4:this.IVARetenido4, retencion6:this.IVARetenido6, retencionIVA_2_3:this.retencion_2_3}
                }).then(data => {
