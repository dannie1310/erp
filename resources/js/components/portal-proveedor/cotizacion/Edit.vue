                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row" v-if="invitacion.cotizacionCompra.partidas">
                                    <div  class="col-md-12">
                                                ...
                                                <tbody v-if="invitacion.cotizacionCompra.partidas">
                                                    <tr v-for="(partida, i) in invitacion.cotizacionCompra.partidas.data">
                                                       ...
                                                       <!-- <td style="text-align:right;">{{'$' + parseFloat((partida.cantidad) * partida.precio_unitario).formatMoney(2,'.',',')}}</td>-->
                                                        ...
                                                        <!--<td style="text-align:right;">{{'$' + parseFloat(partida.cantidad * partida.precio_unitario * tipo_cambio[moneda_input[i]]).formatMoney(2, '.', ',')}}</td>-->
        ...
        methods : {
            ...
            find() {
                ...
                return this.$store.dispatch('padronProveedores/invitacion/find', {
                    id: this.id,
                    params:{ include: ['solicitudCompra','cotizacionCompra.complemento','cotizacionCompra.empresa','cotizacionCompra.sucursal','cotizacionCompra.partidas'], scope: ['invitadoAutenticado']}
                }).then(data => {
            ...
            calcular()
            {
                ...
                this.euros = 0;
                this.libras = 0;
                /*while(this.x < this.invitacion.cotizacionCompra.partidas.data.length)
                {
