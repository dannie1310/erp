                                                ...
                                                <tbody>
                                                    <tr v-for="(exclusion, i) in invitacion.cotizacionCompra.exclusiones.data">
                                                        ...
                                                        <td v-if="exclusion.id == undefined">
                                                            <input type="text"
                                                                   class="form-control"
                                                                   :name="`precio_exclusion[${i}]`"
                                                                   style="text-align: right"
                                                                   :data-vv-as="`'Precio ${i + 1}'`"
                                                                   v-validate="{required: true, min_value:0.01, regex: /^[0-9]\d*(\.\d+)?$/}"
                                                                   :class="{'is-invalid': errors.has(`precio_exclusion[${i}]`)}"
                                                                   v-model="exclusion.precio_unitario"/>
                                                            <div class="invalid-feedback" v-show="errors.has(`precio_exclusion[${i}]`)">Campo Obligatorio</div>
                                                        </td>
        ...
        methods : {
            ...
            registrar() {
                ...
                else
                {
                    ...
                    this.solicitud.id_invitacion = this.id_invitacion;
                    this.solicitud.id = this.invitacion.solicitud_compra.id;
                    this.solicitud.pendiente = 0;
                    this.solicitud.fecha_cot = this.invitacion.cotizacionCompra.fecha;
                    ...
                    this.solicitud.observaciones_cot = this.invitacion.cotizacionCompra.observaciones;
                    this.solicitud.pago = this.invitacion.cotizacionCompra.complemento.parcialidades;
                    this.solicitud.anticipo = this.invitacion.cotizacionCompra.complemento.anticipo;
                    this.solicitud.credito = this.invitacion.cotizacionCompra.complemento.dias_credito;
                    this.solicitud.tiempo = this.invitacion.cotizacionCompra.complemento.entrega;
                    this.solicitud.vigencia = this.invitacion.cotizacionCompra.complemento.vigencia;
                    ...
                    this.solicitud.exclusiones = this.invitacion.cotizacionCompra.exclusiones.data;
                    this.solicitud.partidas = this.invitacion.cotizacionCompra.partidasEdicion.data;
