                        ...
                        <table id="tabla-conceptos">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="numerico">{{ invitacion.cotizacionCompra.subtotal }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="numerico">{{invitacion.cotizacionCompra.impuesto}}</td>
                                </tr>
                                <tr>
                                    <td colspan="9" style="text-align: right" class="sin_borde">Total:</td>
                                    <td class="numerico"><b>{{invitacion.cotizacionCompra.importe}}</b></td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
