        ...
        data() {
            return {
                ...
                columns: [
                    ...
                    { title: 'Estado', field: 'estado', sortable: false, tdClass: 'td_c120', tdComp: require('./partials/EstatusLabel').default},
                    { title: 'Acciones', field: 'buttons', tdClass: 'td_c120',  tdComp: require('./partials/ActionButtons').default},
                ],
                data: [],
                total: 0,
