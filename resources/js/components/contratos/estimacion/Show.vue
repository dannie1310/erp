                  ...
                  <thead>
                    <tr>
                      ...
                      <th
                        class="text-right"
                        scope="col"
                      >{{ estimacion.estimacion.numero_folio_format }}</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      ...
                      <td
                        class="text-right"
                        v-if="estimacion.numEstimacion"
                      >{{ estimacion.numEstimacion.NumeroFolioConsecutivo }}</td>
                    ...
                    <tr>
                      ...
                      <td
                        class="text-right"
                      >De : {{ estimacion.fecha_inicial }} A: {{ estimacion.fecha_final }}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
...
export default {
  ...
  methods: {
    find() {
      ...
      return this.$store
        .dispatch("contratos/estimacion/showEstimacionTable", {
          id: this.id
        })
        .then(data => {
