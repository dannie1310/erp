<template>
    <span>
        <div class="btn-group">
            ...
            <router-link  :to="{ name: 'estimacion-documentos', params: {id: value.id}}" v-if="$root.can('consultar_estimacion_subcontrato')" type="button" class="btn btn-sm btn-outline-primary" title="Ver Documentos">
