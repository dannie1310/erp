<template>
    <span>
        <button type="button" @click="init()" class="btn btn-primary float-right" :disabled="cargando" v-if="$root.can('registrar_retencion_estimacion_subcontrato') || $root.can('registrar_liberacion_estimacion_subcontrato') || $root.can('eliminar_retencion_estimacion_subcontrato') || $root.can('eliminar_liberacion_estimacion_subcontrato')" >
            Retenciones
        </button>
        <div class="row">
            <div class="col-md-12">
