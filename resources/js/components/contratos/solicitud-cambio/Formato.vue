            ...
            <div class="modal-dialog modal-lg" id="mdialTamanio">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Formato de Solicitud de Cambio a Subcontrato</h4>
...
<script>
    export default {
        ...
        methods: {
            ...
            pdf(){
                var url = '/api/contratos/solicitud-cambio/' + this.id +'/formato?db=' + this.$session.get('db') + '&idobra=' + this.$session.get('id_obra')+'&access_token='+this.$session.get('jwt');
                $(this.$refs.body).html('<iframe src="'+url+'"  frameborder="0" height="100%" width="100%">Formato Solicitud Cambio</iframe>');
