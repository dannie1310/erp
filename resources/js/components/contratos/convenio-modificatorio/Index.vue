<template>
    <div class="row">
        <div class="col-12">
            <router-link :to="{name: 'convenio-modificatorio-create'}" v-if="$root.can('registrar_convenio_modificatorio')" class="btn btn-app btn-info float-right" :disabled="cargando">
