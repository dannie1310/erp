        ...
        data() {
            return {
                ...
                columns: [
                    ...
                    { title: 'Folio', field: 'id', thComp: require('../../../globals/th-Filter').default, sortable: true },
                    { title: 'Tipo', field: 'tipo_solicitud__descripcion', thComp: require('../../../globals/th-Filter').default, },
                    { title: 'Fecha', field: 'fecha', thClass: 'th_fecha', sortable: true },
                    { title: 'Referencia', field: 'referencia', thComp: require('../../../globals/th-Filter').default},
                    { title: 'Folio Subcontrato', field: 'subcontrato__numero_folio', thClass: 'th_folio', thComp: require('../../../globals/th-Filter').default, sortable: true },
                    { title: 'Importe', field: 'importe', tdClass: 'money', thClass: 'th_money'},
                    { title: 'Observaciones', field: 'observaciones'},
                    { title: 'Estatus', field: 'ctg_tipos_mov_sol__estado_resultante_desc', thComp: require('../../../globals/th-Filter').default, sortable: true},
