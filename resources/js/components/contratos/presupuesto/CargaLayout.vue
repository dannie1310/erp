<template>
    <span>
        <button @click="load()" type="button" class="btn btn-sm btn-outline-success" :disabled="cargando" title="Cargar Layout Presupuesto">
...
<script>
    export default {
        name: "cargar-layout-presupuesto",
        props: ['id'],
        data() {
            return {
                cargando: false,
        ...
        methods:{
            ...
            cargarLayout(){
                ...
                return this.$store.dispatch('contratos/presupuesto/cargaLayout',
                    {
                        data: formData,
                        config: {
                            params: { _method: 'POST'}
