...
<script>
    export default {
        ...
        methods: {
            pdf(){
                var url = '/api/compras/solicitud-compra/'+this.id +'/comparativa-cotizaciones/pdf?db=' + this.$session.get('db') + '&idobra=' + this.$session.get('id_obra')+'&access_token='+this.$session.get('jwt');
