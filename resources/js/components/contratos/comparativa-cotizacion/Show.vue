                            ...
                            <tfoot  v-if="cantidad_cotizaciones != 0">
                                ...
                                <tr>
                                    ...
                                    <template v-for = "(cotizacion, c) in cotizaciones" >
                                        ...
                                        <td style="text-align: right" :class=" c == mejor_cotizacion ?`mejor_cotizacion`:``">{{cotizacion.descuento_global_format}}</td>
                                    </template>
                                ...
                                <tr>
                                    <td colspan="4" style="border: none"></td>
                                    <template v-for = "(cotizacion, c) in cotizaciones" >
                                        <td colspan="4" style="text-align: right;border:none" class="titulo" >IVA ({{cotizacion.tasa_iva}}%):</td>
                ...
                <div class="row" v-if="cantidad_cotizaciones == 0">
                    <div class="col-md-12">
                        <div class="alert alert-warning" role="alert">
                            No tiene presupuestos abiertos.
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    components: {EncabezadoContratoProyectado, Datepicker},
    props: ['id'],
    data(){
        return{
            mejor_cotizacion : '',
    ...
    methods: {
        find() {
            this.cargando = true;
            return this.$store.dispatch('contratos/contrato-proyectado/getComparativaCotizaciones', {
                id: this.id,
