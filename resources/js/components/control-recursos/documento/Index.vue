        ...
        documentos: {
            handler(documentos) {
                ...
                self.$data.data = documentos.map((documento, i) => ({
                    ...
                    folioSolicitud: documento.folio_solicitud,
                    ...
                    buttons: $.extend({}, {
                        ...
                        xml_ifs : self.$root.can('descargar_xml_documento_ifs_recursos', true) && (documento.estado == 7 || documento.estado == 2 ) ? true : false,
                        correo_xml_ifs : self.$root.can('enviar_correo_xml_documento_ifs_recursos', true) && (documento.estado == 7 || documento.estado == 2 ) ? true : false,
                    }),
