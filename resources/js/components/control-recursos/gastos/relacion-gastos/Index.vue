    ...
    export default {
        ...
        data() {
            return {
                ...
                data: [],
                total: 0,
                query: {include: [], sort: 'timestamp_registro', order: 'desc'},
                cargando: false
            }
        },
                ...
                handler(relaciones) {
                    ...
                    self.$data.data = relaciones.map((relacion, i) => ({
                            ...
                            buttons: $.extend({}, {
                                ...
                                solicitar_reembolso_caja: self.$root.can('registrar_reembolso_por_caja_chica', true) && relacion.estado == 5 ? true : false,
