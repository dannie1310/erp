<template>
    <div class="btn-group">
        ...
        <router-link :to="{ name: 'solicitud-reembolso-edit', params: {id: value.id_solicitud}}" v-if="value.sol_cheque_pago_a_proveedor" type="button" class="btn btn-sm btn-outline-dark" title="Solicitud">
            <i class="fa fa-upload"></i>
        </router-link>
    </div>
</template>
