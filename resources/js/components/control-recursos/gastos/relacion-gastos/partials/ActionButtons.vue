<template>
    <div class="btn-group">
        ...
        <router-link :to="{ name: 'reembolso-caja-chica', params: {id: value.id_documento}}" v-if="value.reembolso_caja_chica" type="button" class="btn btn-sm btn-outline-dark" title="Reembolso - Caja Chica">
            <i class="fa fa-upload"></i>
        </router-link>
