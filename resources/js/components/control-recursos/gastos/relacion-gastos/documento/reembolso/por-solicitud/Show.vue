    ...
    <span>
        ...
        <div class="card" v-else>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <h4>Documento para Reembolso1</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
            ...
            <div class="modal-footer">
                <div class="pull-right">
                    ...
                    <button type="submit" class="btn btn-info" :disabled="errors.count() > 0" @click="editar" v-if="$root.can('editar_reembolso_por_solicitud', true)"><i class="fa fa-save" ></i> Actualizar</button>
                    <button type="submit" class="btn btn-danger" :disabled="errors.count() > 0" @click="eliminar" v-if="$root.can('eliminar_reembolso_por_solicitud', true)"><i class="fa fa-trash"></i> Eliminar</button>
