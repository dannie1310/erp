    ...
    data() {
        return {
            ...
            columns: [
                ...
                { title: '', field: 'buttons', thClass:'th_c50', tdClass:'center',  tdComp: require('./partials/ActionButtons').default}
            ],
            data: [],
            total: 0,
        ...
        empresas: {
            handler(empresas) {
                ...
                self.$data.data = empresas.map((empresa, i) => ({
                    ...
                    buttons: $.extend({}, {
                        delete: (empresa.editable == 1) ? true :false && self.$root.can('eliminar_empresa_boletinada', true) ? true : false,
                        edit: (empresa.editable == 1) ? true :false && self.$root.can('editar_empresa_boletinada', true)? true : false,
                        id: empresa.id,
                    })
                }));
            },
