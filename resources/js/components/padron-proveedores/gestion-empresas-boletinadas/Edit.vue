<template>
    <div class="row">
        <div class="col-12">
            <button type="button" class="btn btn-sm btn-outline-primary" title="Editar" @click="init">
            ...
            <div class="modal-dialog modal-dialog-centered modal" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle"><i class="fa fa-pencil"></i> Editar Empresa Boletinada</h5>
                            ...
                            <div class="col-md-12">
                                <div class="btn-group btn-group-toggle">
                                    <label class="btn btn-outline-secondary"
                                           :class="empresa_motivo_boletinada === key ? 'active': ''"
                                           v-for="(tipo_boletinada, key) in tipos_boletinada"
                                           :key="key">
                                        <input type="radio"
    ...
    methods:{
        ...
        find()
        {
            ...
            return this.$store.dispatch('padronProveedores/empresa-boletinada/find', {
                ...
                this.empresa_motivo_boletinada = ''+data.id_motivo+'';
                this.rfc = data.rfc;
        ...
        store() {
            ...
            return this.$store.dispatch('padronProveedores/empresa-boletinada/update',
                {
                    id: this.id,
                    data: this.datos_store
                })
                .then((data) => {
                    this.$store.commit('padronProveedores/empresa-boletinada/UPDATE_EMPRESA', data);
                    $(this.$refs.modal).modal('hide');
                });
        }
    }
