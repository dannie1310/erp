        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" :disabled="errors.count() > 0" @click="validate" v-if="$root.can('editar_expediente_proveedor', true)"><i class="fa fa-save"></i> Guardar</button>
                </div>
            </div>
        </div>
    </span>
