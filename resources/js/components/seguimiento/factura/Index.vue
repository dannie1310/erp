            ...
            facturas: {
                handler(facturas) {
                    ...
                    self.$data.data = facturas.map((factura, i) => ({
                        ...
                        fecha: factura.fecha_registro_format,
                        ...
                        total : factura.total_format,
                        fecha_emision: factura.fecha_format,
                        ...
                        buttons: $.extend({}, {
                            ...
                            envioCorreo: (this.$root.can('reenviar_email_factura_cuenta_x_cobrar',true) && factura.estado != 3) ? true : false,
                        })
                    }));
                },
                deep: true
