                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group error-content">
                                   ...
                                   <datepicker v-model = "fecha_fallo"
                                               id="fecha"
                                               name = "fecha"
                                               :format = "formatoFecha"
                                               :language = "es"
                                        ...
                                        <tbody>
                                            <tr v-for="(participante, i) in this.concurso_store.participantes.data">
                                                ...
                                                <td style="text-align: center">
                                                    <i class="fa fa-check" v-if="participante.es_empresa_hermes" />

                                                </td>
                                                <td style="text-align: center">
                                                    <check-es-ganador v-bind:id="concurso_store.id" v-bind:participante="participante" v-bind:actualizando="true"></check-es-ganador>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                    ...
                    <div class="modal-footer">
                        <div class="pull-right">
                            <button type="button" class="btn btn-secondary" v-on:click="regresar" :disabled="actualizando">
                                ...
                                Regresar</button>
                            &nbsp;
                            <button type="button" @click="update" class="btn btn-primary pull-right" :disabled="actualizando">
