        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                <a href="#" class="nav-link" @click="mostrarMenu($event)">
                    <i class="fa fa-support nav-icon"></i>
                    <p>Activos</p>
                    <i class="right fa fa-angle-left"></i>
                </a>
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <router-link :to="{name: 'activos-administrar'}" class="nav-link" :class="{active: this.$route.name == 'activos-administrar'}">
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <router-link :to="{name: 'resguardos-index'}" class="nav-link" :class="{active: this.$route.name == 'resguardos-index'}">
                            <i class="fa fa-circle-o nav-icon"></i>
                            <p>Consultar</p>
                        </router-link>
                    </li>
