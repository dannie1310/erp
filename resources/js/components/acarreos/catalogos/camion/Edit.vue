                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    <input disabled="true"
                                           ...
                                           id="vigencia_poliza"
                                           class="form-control"
                                           v-model="camion.vigencia_poliza" />
                                </div>
                            </div>
                        </div>
                    </div>
