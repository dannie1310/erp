            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle"> <i class="fa fa-close"></i> DESACTIVAR MATERIAL</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div v-else>
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                <h6>{{material.usuario_registro}}</h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <h6>{{material.fecha_registro_format}}</h6>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                            ...
                            <div class="card" v-if="material.estado == 1">
                                <div class="card-body">
                                    <div class="col-md-12">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" @click="validate" :disabled="errors.count() > 0" v-if="material">
...
<script>
    export default {
        ...
        methods: {
            ...
            desactivar() {
                return this.$store.dispatch('acarreos/material/desactivar', {
                    id: this.id,
                    params: {motivo: this.motivo}})
                    .then((data) => {
                        this.$store.commit('acarreos/material/UPDATE_MATERIAL', data);
                        $(this.$refs.modal).modal('hide');
                    })
            }
        },
