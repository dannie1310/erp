            ...
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle"><i class="fa fa-clock"></i> CONSULTAR HISTÓRICO TELEFONO</h5>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                     <tr v-for="(historico, i) in historicos">
                                         <td>{{i+1}}</td>
                                         <td>{{historico.imei}}</td>
                                         <td>{{historico.id_dispositivo}}</td>
                                         <td>{{historico.linea}}</td>
