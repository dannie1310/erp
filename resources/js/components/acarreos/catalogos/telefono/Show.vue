<template>
    <span>
        <button @click="init" type="button" class="btn btn-sm btn-outline-secondary" title="Ver">
            <i class="fa fa-eye"></i>
        </button>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle"><i class="fa fa-eye"></i> CONSULTAR TELÉFONO</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div v-else>
                            <div class="row justify-content-end">
                                <historico v-bind:historicos="telefono.historicos.data" v-bind:id="id" v-if="telefono" />
                            </div>
                            <div class="row">
                                <div class="col-md-6">
