<template>
    <span>
        <button @click="init" v-if="$root.can('registrar_marca')" class="btn btn-app pull-right">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle"><i class="fa fa-plus"></i> REGISTRAR MARCA</h5>
...
<script>
    export default {
        ...
        methods : {
            ...
            store() {
                return this.$store.dispatch('acarreos/marca/store', {
