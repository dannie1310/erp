<template>
    <span>
        <button @click="abrirHistorico()" class="btn btn btn-primary float-right">
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle"><i class="fa fa-clock"></i> CONSULTAR HISTÓRICO OPERADOR</h5>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                     <tr v-for="(historico, i) in historicos">
                                         ...
                                         <td>{{historico.direccion}}</td>
                                         <td>{{historico.no_licencia}}</td>
                                         <td>{{historico.vigencia_licencia_format}}</td>
                                         <td>{{historico.fecha_alta_format}}</td>
                                         <td>{{historico.fecha_baja_format}}</td>
