<template>
    <span v-if="solicitud_edit">
                    ...
                    <tbody>
                        <tr>
                            <td class="bg-gray-light">
                                <b>Folio: </b>{{solicitud_edit.numero_folio_format}}
                            </td>
                            <td class="bg-gray-light">
                                <b>Tipo: </b>{{solicitud_edit.tipo_solicitud}}
                            </td>
        ...
        <span v-if="solicitud_edit.id_tipo ==1">
            <div class="row" >
                <div class="col-md-12">
        ...
        <span v-else-if="solicitud_edit.id_tipo==2">
            <div class="row"  >
                <div class="col-md-12">
                    <h6>-Base de Datos: {{solicitud_edit.base_datos}} -Cantidad de Partidas: {{solicitud_edit.numero_partidas}} -Cantidad de Pólizas: {{solicitud_edit.numero_polizas}} -Cantidad de Movimientos: {{solicitud_edit.numero_movimientos}} </h6>
                </div>
            </div>
            <div class="row"  >
                <div class="col-md-12">
                            ...
                            <tbody>
                                <template v-for="(partida, i) in solicitud_edit.partidas.data">
                                    <tr >
                                        <td>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" :id="`cumplido${i}`"  v-model="partida.estado">
                                                <label :for="`cumplido${i}`" class="custom-control-label" v-model="partida.estado"></label>
                                            </div>
                                        </td>
                                        <td>{{i+1}}</td>
        ...
        <span v-else-if="solicitud_edit.id_tipo==3">
            <div class="row"  >
                <div class="col-md-12">
                    <h6>-Base de Datos: {{solicitud_edit.base_datos}} -Cantidad de Partidas: {{solicitud_edit.numero_partidas}} -Cantidad de Pólizas: {{solicitud_edit.numero_polizas}} -Cantidad de Movimientos: {{solicitud_edit.numero_movimientos}} </h6>
                </div>
        ...
        <span v-else-if="solicitud_edit.id_tipo==4">
            <div class="row"  >
                <div class="col-md-12">
                    <h6>-Base de Datos: {{solicitud_edit.base_datos}} -Cantidad de Cuentas: {{solicitud_edit.numero_cuentas}}  </h6>
                </div>
            </div>
            <div class="row"  >
                <div class="col-md-12">
