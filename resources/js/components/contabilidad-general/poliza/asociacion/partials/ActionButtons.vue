<template>
    <div class="btn-group">
        <router-link  :to="{ name: 'poliza-contpaq-asociacion-show', params: {id: value.id, id_empresa: this.value.id_empresa}}" v-if="$root.can('consultar_poliza',1)" type="button" class="btn btn-sm btn-outline-secondary" title="Ver">
            <i class="fa fa-eye"></i>
        </router-link>
