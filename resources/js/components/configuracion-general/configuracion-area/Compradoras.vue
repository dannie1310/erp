<template>
    <span>
        <div class="card" id="compradoras">
            <div class="card-header">
                <h6 class="card-title">Asignación de Áreas Compradoras</h6>
            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <div class="form-group">
                                    <label for="from">AREAS COMPRADORAS A ASIGNAR</label>
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    <label for="to">AREAS COMPRADORAS DISPONIBLES</label>
                            ...
                            <table class="table">
                                <tr>
                                 ...
                                 <tr  v-if="areas_nuevos_asignados.length">
                                    <th>Areas Compradoras a Asignar:</th>
                                    <td>
                                        <ul>
                                ...
                                <tr v-if="areas_desasignados.length">
                                    <th>Areas Compradoras a Desasignar:</th>
                                    <td>
                                        <ul>
