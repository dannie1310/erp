                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <div class="form-group">
                                    <label for="from">AREAS SOLICITANTES A ASIGNAR</label>
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    <label for="to">AREAS SOLICITANTES DISPONIBLES</label>
                            ...
                            <table class="table">
                                <tr>
                                 ...
                                 <tr  v-if="areas_nuevos_asignados.length">
                                    <th>Areas Solicitantes a Asignar:</th>
                                    <td>
                                        <ul>
                                ...
                                <tr v-if="areas_desasignados.length">
                                    <th>Areas Solicitantes a Desasignar:</th>
                                    <td>
                                        <ul>
