<template>
    <span>
        <button @click="find(maquinaria)" type="button" class="btn btn-sm btn-outline-info" title="Editar Maquinaria" v-show="update">
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle"> <i class="fa fa-pencil"></i> EDITAR MAQUINARIA</h5>
