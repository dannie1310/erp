<template>
    <div class="btn-group">
        ...
        <button @click="solicitarAutorizacionParaRemesa"  v-if="value.solicitud_autorizacion && value.estado === 0" type="button" class="btn btn-sm btn-outline-primary" title="Solicitar autorización para incluir en remesa"><i class="fa fa-unlock"></i></button>
