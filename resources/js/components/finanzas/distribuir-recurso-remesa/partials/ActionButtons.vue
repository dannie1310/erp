<template>
    <div class="btn-group">
        ...
        <button @click="cancelar" v-if="value.cancelar && (value.estado === 0 || value.estado === 1)" type="button" class="btn btn-sm btn-outline-danger" title="Cancelar"><i class="fa fa-ban"></i></button>
    </div>
</template>
