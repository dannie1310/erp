        ...
        data(){
            return{
                ...
                columns: [
                    ...
                    { title: 'Folio', field: 'id_transaccion',thComp: require('../../globals/th-Filter').default, sortable: true},
                ...
                total: 0,
                query: {
                    include: ['contra_recibo','empresa','relaciones'], sort: 'id_transaccion',  order: 'desc'
                },
                cargando: false
                    ...
                    facturas.forEach(function (factura, i) {
                        self.$data.data.push({
                            ...
                            buttons: $.extend({}, {
                                ...
                                relaciones: factura.relaciones.data,
                            })
