        ...
        methods: {
            ...
            find(id) {
                axios.all([
                    ...
                    .then(() => {
                        this.$store.dispatch('finanzas/traspaso-entre-cuentas/find', {
                            id: id,
            ...
            update() {
                return this.$store.dispatch('finanzas/traspaso-entre-cuentas/update', {
                    id: this.id,
                    data: {
                    ...
                    .then(data => {
                        ...
                        this.$store.commit('finanzas/traspaso-entre-cuentas/UPDATE_TRASPASO', data);
                    })
            },
