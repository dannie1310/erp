...
<script>
    export default {
        ...
        methods: {
            find(id) {
                this.$store.commit('finanzas/movimiento-bancario/SET_MOVIMIENTO', null);
                return this.$store.dispatch('finanzas/movimiento-bancario/find', {
                    id: id,
        ...
        computed: {
            movimiento() {
                return this.$store.getters['finanzas/movimiento-bancario/currentMovimiento']
            }
        }
    }
</script>