...
<script>
    export default {
        ...
        computed: {
            movimiento() {
                return (this.$store.getters['finanzas/movimiento-bancario/currentMovimiento'] != null && this.$store.getters['finanzas/movimiento-bancario/currentMovimiento'].id == this.id) ?  this.$store.getters['finanzas/movimiento-bancario/currentMovimiento'] : null
            },
        ...
        methods: {
            getTiposMovimiento() {
                return this.$store.dispatch('finanzas/tipo-movimiento/index')
                    .then(data => {
            ...
            find(id) {
                axios.all([
                    ...
                    .then(() => {
                        this.$store.dispatch('finanzas/movimiento-bancario/find', {
                            id: id,
            ...
            update() {
                return this.$store.dispatch('finanzas/movimiento-bancario/update', {
                    id: this.id,
                    data: {
                    ...
                    .then(data => {
                        this.$store.commit('finanzas/movimiento-bancario/UPDATE_MOVIMIENTO', data);
            ...
            updateAttribute(e) {
                return this.$store.commit('finanzas/movimiento-bancario/UPDATE_ATTRIBUTE', {attribute: $(e.target).attr('name'), value: e.target.value})
            }
        }
    }
</script>
