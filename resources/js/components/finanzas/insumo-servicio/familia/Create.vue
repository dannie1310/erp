<template>
    <span>
        <button @click="init" v-if="$root.can('registrar_familia_servicio')" class="btn btn-app btn-info float-right" :disabled="cargando">
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle"> <i class="fa fa-plus"></i> REGISTRAR FAMILIA DE SERVICIO</h5>
