        ...
        data() {
            return {
                ...
                columns: [
                    ...
                    { title: 'Fecha Presunto SAT', field: 'fecha_presunto', sortable: false},
                    { title: 'Fecha Presunto DOF', field: 'fecha_presunto_dof', sortable: false},
                    { title: 'Fecha Definitivo SAT', field: 'fecha_definitivo', sortable: false},
                    { title: 'Fecha Definitivo DOF', field: 'fecha_definitivo_dof', sortable: false},
                    { title: 'Fecha Sentencia Favorable SAT', field: 'fecha_sentencia_favorable', sortable: false},
                    { title: 'Fecha Sentencia Favorable DOF', field: 'fecha_sentencia_favorable_dof', sortable: false},
                    { title: 'Fecha Desvirtuado SAT', field: 'fecha_desvirtuado', sortable: false},
