<template>
    <span>
        <button @click="load" class="btn btn-app btn-info pull-right" title="Cargar Layout" :disabled="cargando">
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle"><i class="fa fa-upload"></i> Registrar asignación con layout</h5>
