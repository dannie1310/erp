<template>
    <span>
        <button @click="find(material)" type="button" class="btn btn-sm btn-outline-danger" title="Eliminar Material" v-show="borrar">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-unidad"> <i class="fas fa-trash-alt"></i> ELIMINAR MATERIAL</h5>
                            ...
                            <div class="col-md-12">
                                    <div class="form-group row error-content">
                                        <!-- <label for="unidad" class="col-sm-2 offset-1" style="text-align:right;">Unidad: &nbsp;</label>
                                            {{res.unidad}} -->
                                        <label for="unidad" class="col-sm-3" style="text-align:right;">Material: &nbsp;</label>
                                        {{res.descripcion}}
                                    </div>
                                    <div class="form-group row error-content">
...
<script>
export default {
    name: "material-eliminar",
    props: ['material', 'borrar'],
    data() {
        return {
            cargando: false,
            id: '',
