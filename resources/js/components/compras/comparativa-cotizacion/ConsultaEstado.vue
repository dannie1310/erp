                                         ...
                                         <table class="table table-sm table-bordered">
                                             <thead>
                                                 <tr>
                                                     ...
                                                     <th v-for="cotizacion in solicitud.detalleEstadoCotizacion.titulos"  v-if="cotizacion.id_transaccion != ''" class="no_negrita">
                                                 ...
                                                 <tr>
                                                     ...
                                                     <th v-for="cotizacion in solicitud.detalleEstadoCotizacion.titulos" v-if="cotizacion.id_transaccion == ''" class="no_negrita"></th>
                                                 </tr>
                                                 <tr>
                                                     <th >#</th>
                                                     <th >Material</th>
