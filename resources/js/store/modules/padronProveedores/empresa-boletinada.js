const URI = '/api/padron-proveedores/empresa-boletinada/';
...
export default {
    ...
    actions: {
        ...
        findRFC(context, payload) {
            return new Promise((resolve, reject) => {
                axios
                    .get(URI  +payload.rfc, { params: payload.params })
                    .then(r => r.data)
                    .then(data => {
                        resolve(data);
                    })
        ...
        delete(context, payload) {
            return new Promise((resolve, reject) => {
                swal({
                    title: "Eliminar Empresa Boletinada",
                    text: "¿Está seguro de que desea eliminar la empresa?",
                    icon: "warning",
                    buttons: {
                        cancel: {
                            text: 'Cancelar',
                    ...
                    .then((value) => {
                        if (value) {
                            axios
                                ...
                                .then(r => r.data)
                                .then(data => {
                                    swal("Empresa boletinada eliminada correctamente", {
                                        icon: "success",
                                        timer: 1500,
                                        buttons: false
                                    }).then(() => {
