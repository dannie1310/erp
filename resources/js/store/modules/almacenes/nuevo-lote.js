const URI = '/api/almacenes/ajuste-inventario/nuevo-lote/';
export default{
    namespaced: true,
    state: {
        ajustes: [],
    ...
    actions: {
                    ...
                    .then((value) => {
                        if (value) {
                            axios
                                ...
                                .then(r => r.data)
                                .then(data => {
                                    swal("Nuevo Lote registrado correctamente", {
                                        icon: "success",
                                        timer: 2000,
                                        buttons: false
                                    }).then(() => {
        ...
        eliminar(context, payload) {
            return new Promise((resolve, reject) => {
                swal({
                    title: "Eliminar Nuevo Lote de Ajuste de Inventario",
