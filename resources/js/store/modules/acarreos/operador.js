...
export default{
    ...
    mutations: {
        ...
        UPDATE_OPERADOR(state, data) {
            state.operadores = state.operadores.map(operador => {
                if (operador.id === data.id) {
                    return Object.assign({}, operador, data)
                }
                return operador
            })
            state.currentOperador = data;
                    ...
                    .then((value) => {
                        if (value) {
                            axios
                                ...
                                .then(r => r.data)
                                .then(data => {
                                    swal("Operador registrado correctamente", {
                                        icon: "success",
                                        timer: 1500,
                                        buttons: false
                                    }).then(() => {
        ...
        activar(context, payload) {
            return new Promise((resolve, reject) => {
                swal({
                    ...
                    text: "¿Está seguro de que desea activar al operador?",
                    icon: "warning",
                    buttons: {
                        cancel: {
                            text: 'Cancelar',
                    ...
                    .then((value) => {
                        if (value) {
                            axios
                                ...
                                .then(r => r.data)
                                .then(data => {
                                    swal("Operador activado correctamente", {
                                        icon: "success",
                                        timer: 1500,
                                        buttons: false
                                    }).then(() => {
        ...
        desactivar(context, payload) {
            return new Promise((resolve, reject) => {
                swal({
                    ...
                    text: "¿Está seguro de que desea desactivar al operador?",
                    icon: "warning",
                    buttons: {
                        cancel: {
                            text: 'Cancelar',
                    ...
                    .then((value) => {
                        if (value) {
                            axios
                                ...
                                .then(r => r.data)
                                .then(data => {
                                    swal("Operador desactivado correctamente", {
                                        icon: "success",
                                        timer: 1500,
                                        buttons: false
                                    }).then(() => {
                    ...
                    .then((value) => {
                        if (value) {
                            axios
                                ...
                                .then(r => r.data)
                                .then(data => {
                                    swal("Operador actualizado correctamente", {
                                        icon: "success",
                                        timer: 1500,
                                        buttons: false
                                    })
