const URI = '/api/control-recursos/pago-reembolso-por-solicitud/';
...
export default {
    ...
    actions: {
        ...
        store(context, payload) {
            return new Promise((resolve, reject) => {
                swal({
                    title: "Registrar Solicitud Pago Reembolso Por Solicitud",
        ...
        delete(context, payload) {
            return new Promise((resolve, reject) => {
                swal({
                    ...
                    text: "¿Está seguro de que desea eliminar la solicitud?",
                    icon: "warning",
                    buttons: {
                        cancel: {
                            text: 'Cancelar',
                    ...
                    .then((value) => {
                        if (value) {
                            axios
                                ...
                                .then(r => r.data)
                                .then(data => {
                                    swal("Solicitud eliminado correctamente", {
                                        icon: "success",
                                        timer: 1500,
                                        buttons: false
                                    }).then(() => {
