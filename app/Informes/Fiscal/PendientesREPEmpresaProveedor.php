...
class PendientesREPEmpresaProveedor
{
    ...
    {
        $informe["partidas"] = PendientesREPEmpresaProveedor::getPartidas($data);
        $informe["fechas"] = PendientesREPEmpresaProveedor::getFechasInforme();
        $informe["filtros_txt"] = PendientesREPEmpresaProveedor::getFiltrosTxt($data);
    ...
    private static function getPartidas($data){
        ...
        $filtros = PendientesREPEmpresaProveedor::getQueryFiltros($data);
        $informe = DB::select("
SELECT
