...
class AsignacionFormato extends Rotation
{
    ...
    private function firmas()
    {
        ...
        {
            $this->Cell(4.3, .4, utf8_decode('Elaboró'), 'TRLB', 0, 'C', 0);
            $this->Cell(4.3, .4, utf8_decode('Validó Gerencia Responsable Compra'), 'TRLB', 0, 'C', 0);
            $this->Cell(4, .4, utf8_decode('Aprobó'), 'TRLB', 0, 'C', 0);
            $this->Cell(4.5, .4, utf8_decode('VoBo Dir. General de Construcción'), 'TRLB', 0, 'C', 0);
            $this->Cell(5, .4, utf8_decode('Autoriza Dir. Ejec. Admon. y Finanzas'), 'TRLB', 0, 'C', 0);
            $this->Cell(4.5, .4, utf8_decode('VoBo Dir. Gral'), 'TRLB', 0, 'C', 0);

            $this->Ln();
            $this->Cell(4.3, 1.2, '', 'TRLB', 0, 'C');
            $this->Cell(4.3, 1.2, '', 'TRLB', 0, 'C');
            $this->Cell(4, 1.2, '', 'TRLB', 0, 'C');
            $this->Cell(4.5, 1.2, '', 'TRLB', 0, 'C');
            $this->Cell(5, 1.2, '', 'TRLB', 0, 'C');
            $this->Cell(4.5, 1.2, '', 'TRLB', 0, 'C');

            $this->Ln();
            $this->Cell(4.3, .4, utf8_decode(''), 'TRLB', 0, 'C', 0);
            $this->Cell(4.3, .4, utf8_decode('ING. JOSE MARTÍN ORTIZ VAZQUEZ'), 'TRLB', 0, 'C', 0);
            $this->Cell(4, .4, utf8_decode('DIR. PROYECTO'), 'TRLB', 0, 'C', 0);
            $this->Cell(4.5, .4, utf8_decode('ING. LUIS HORCASITAS MANJARREZ'), 'TRLB', 0, 'C', 0);
            $this->Cell(5, .4, utf8_decode('ING. LUIS HUMBERTO ESPINOSA HERNANDEZ'), 'TRLB', 0, 'C', 0);
            $this->Cell(4.5, .4, utf8_decode('ING. GASPAR GUERREIRO GONZÁLEZ'), 'TRLB', 0, 'C', 0);
            ...
            $this->Cell(.2);
            $this->Cell(4.3, .4, utf8_decode('VoBo Dir. Ejec. de Oper. e Infra.'), 'TRLB', 0, 'C', 0);
            $this->Cell(.2);
            $this->Cell(4.3, .4, utf8_decode('Autoriza Dir. Ejec. Admon. y Finanzas'), 'TRLB', 0, 'C', 0);
            $this->Cell(.2);
            $this->Cell(4.3, .4, utf8_decode('VoBo Dir. Gral'), 'TRLB', 0, 'C', 0);
            $this->Ln();
        ...
        else if (((Context::getDatabase() == "SAO1814_CHIMALHUACAN" && Context::getIdObra() == 5) || (Context::getDatabase() == "SAO1814_CUTZAMALA" && Context::getIdObra() == 7)) && $this->asignacion->solicitud->id_area_compradora == 4)
        {
            $this->Cell(4.1, .4, utf8_decode('Elaboró'), 'TRLB', 0, 'C', 0);
            $this->Cell(.2);
            $this->Cell(4.3, .4, utf8_decode('Validó Gerencia Responsable Compra'), 'TRLB', 0, 'C', 0);
            ...
            $this->Cell(4.3, .4, utf8_decode('Gerencia Solicitante'), 'TRLB', 0, 'C', 0);
            $this->Cell(.2);
            $this->Cell(4.3, .4, utf8_decode('VoBo Dir. General de Construcción'), 'TRLB', 0, 'C', 0);
            $this->Cell(.2);
            $this->Cell(4.3, .4, utf8_decode('Autoriza Dir. Ejec. Admon. y Finanzas'), 'TRLB', 0, 'C', 0);
            $this->Cell(.2);
            $this->Cell(4.3, .4, utf8_decode('VoBo Dir. Gral'), 'TRLB', 0, 'C', 0);
        ...
        {
            $this->Cell(3.4, .4, utf8_decode('Elaboró'), 'TRLB', 0, 'C', 0);
            $this->Cell(.2);
            $this->Cell(3.6, .4, utf8_decode('Validó Gerencia Responsable Compra'), 'TRLB', 0, 'C', 0);
            $this->Cell(.2);
            $this->Cell(3.5, .4, utf8_decode('VoBo Admon. Proyecto'), 'TRLB', 0, 'C', 0);
            $this->Cell(.2);
            $this->Cell(3.5, .4, utf8_decode('VoBo Dir. Proyecto'), 'TRLB', 0, 'C', 0);
            $this->Cell(.2);
            $this->Cell(3.8, .4, utf8_decode('VoBo Dir. General de Construcción'), 'TRLB', 0, 'C', 0);
            $this->Cell(.2);
            $this->Cell(3.6, .4, utf8_decode('Autoriza Dir. Ejec. Admon. y Finanzas'), 'TRLB', 0, 'C', 0);
            $this->Cell(.2);
            $this->Cell(3.9, .4, utf8_decode('VoBo Dir. Gral'), 'TRLB', 0, 'C', 0);

            $this->Ln();
            $this->Cell(3.4, 1.2, '', 'TRL', 0, 'C');
            $this->Cell(.2);
            $this->Cell(3.6, 1.2, '', 'TRL', 0, 'C');
            $this->Cell(.2);
            $this->Cell(3.5, 1.2, '', 'TRL', 0, 'C');
            $this->Cell(.2);
            $this->Cell(3.5, 1.2, '', 'TRL', 0, 'C');
            $this->Cell(.2);
            ...
            $this->Ln();
            $this->Cell(3.4, .4, utf8_decode(''), 'RLB', 0, 'C', 0);
            $this->Cell(.2);
            $this->Cell(3.6, .4, utf8_decode(''), 'RLB', 0, 'C', 0);
            $this->Cell(.2);
            $this->Cell(3.5, .4, utf8_decode(''), 'RLB', 0, 'C', 0);
            $this->Cell(.2);
            $this->Cell(3.5, .4, utf8_decode(''), 'RLB', 0, 'C', 0);
            $this->Cell(.2);
            $this->Cell(3.8, .4, utf8_decode('ING. LUIS HORCASITAS MANJARREZ'), 'TRLB', 0, 'C', 0);
            $this->Cell(.2);
            $this->Cell(3.6, .4, utf8_decode(''), 'RLB', 0, 'C', 0);
            $this->Cell(.2);
            $this->Cell(3.9, .4, utf8_decode('ING. GASPAR GUERREIRO GONZÁLEZ'), 'TRLB', 0, 'C', 0);
            ...
            $this->Ln();
            $this->Cell(4.1, 1.1, '', 'TRL', 0, 'C');
            $this->Cell(.2);
            $this->Cell(4.3, 1.1, '', 'TRL', 0, 'C');
            $this->Cell(.2);
            $this->Cell(4.3, 1.1, '', 'TRL', 0, 'C');
            $this->Cell(.2);
            $this->Cell(4.3, 1.1, '', 'TRLB', 0, 'C');
            $this->Cell(.2);
            $this->Cell(4.3, 1.1, '', 'TRL', 0, 'C');
            $this->Cell(.2);
            $this->Cell(4.3, 1.1, '', 'TRL', 0, 'C');
            ...
            $this->Ln();
            $this->Cell(4.1, 0.4, '', 'RLB', 0, 'C');
            $this->Cell(.2);
            $this->Cell(4.3, 0.4, '', 'RLB', 0, 'C');
            $this->Cell(.2);
            $this->Cell(4.3, 0.4, '', 'RLB', 0, 'C');
            $this->Cell(.2);
            $this->Cell(4.3, 0.4, 'ING. LUIS HORCASITAS MANJARREZ', 'TRLB', 0, 'C');
            $this->Cell(.2);
            $this->Cell(4.3, 0.4, '', 'RLB', 0, 'C');
            $this->Cell(.2);
            $this->Cell(4.3, .4, utf8_decode('ING. GASPAR GUERREIRO GONZÁLEZ'), 'TRLB', 0, 'C', 0);
