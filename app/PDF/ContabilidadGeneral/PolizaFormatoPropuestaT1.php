...
class PolizaFormatoPropuestaT1 extends Rotation
{
    ...
    public function partidas()
    {
        ...
        foreach($this->poliza->poliza->cuentas_padres as $cuenta_padre){
            $suma_cargos = number_format($this->poliza->poliza->sumaMismoPadreCargos($cuenta_padre->Codigo), 2, ".", ",");
            $suma_abonos = number_format($this->poliza->poliza->sumaMismoPadreAbonos($cuenta_padre->Codigo), 2, ".", ",");
