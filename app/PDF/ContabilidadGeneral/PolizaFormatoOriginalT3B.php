...
class PolizaFormatoOriginalT3B extends Rotation
{
    private $poliza;
    private $empresa;
    private $solicitud;
    ...
    public function partidas()
    {
        ...
        foreach($this->poliza->getCuentasPadresOrdenOriginal($this->solicitud) as $cuenta_padre){
            foreach($this->poliza->getMovimientosOrdenOriginal($cuenta_padre, $this->solicitud) as $k => $movimiento){
