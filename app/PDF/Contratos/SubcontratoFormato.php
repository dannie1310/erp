...
class SubcontratoFormato extends FPDI
{
    ...
    function Header(){
        ...
        if($this->encola == 'clausulado' &&$this->subcontrato->clasificacionSubcontrato){
            ...
            $this->Cell(5.5,.5,  $this->obra->descripcion != null ? $this->obra->descripcion : $this->obra->nombre .' ','RT',0,'R');
            $this->Ln(.5);
            ...
            $this->setY($y_inicial);
            $this->setX($x_inicial);
            $this->MultiCell(19.5, 1,  $this->obra->descripcion!=null ? $this->obra->descripcion :  $this->obra->nombre, '', 'C');
