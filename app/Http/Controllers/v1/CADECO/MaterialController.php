...
class MaterialController extends Controller
{
    ...
    public function __construct(Manager $fractal, MaterialService $service, MaterialTransformer $transformer)
    {
        ...
        $this->middleware('permiso:consultar_insumo_material|consultar_insumo_herramienta_equipo|consultar_insumo_servicio')->only(['show','paginate','index','find']);
        $this->middleware('permiso:registrar_insumo_material|registrar_insumo_herramienta_equipo|registrar_insumo_servicio')->only('store');
