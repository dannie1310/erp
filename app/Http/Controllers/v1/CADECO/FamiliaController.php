...
class FamiliaController extends Controller
{
    ...
    public function __construct(FamiliaService $service, FamiliaTransformer $transformer, Manager $fractal)
    {
        ...
        $this->middleware('permiso:consultar_familia_material,consultar_familia_herramienta_equipo,consultar_familia_servicio,consultar_familia_maquinaria')->only(['show','paginate','index','find']);
        $this->middleware('permiso:registrar_familia_herramienta_equipo,registrar_familia_material,registrar_familia_servicio,registrar_familia_maquinaria')->only('store');
