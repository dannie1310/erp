...
class OrdenCompraTransformer extends TransformerAbstract
{
    ...
    public function transform(OrdenCompra $model)
    {
        return [
            ...
            'folio_asignacion' => (string)$model->complemento?$model->complemento->asignacion?$model->complemento->asignacion->folio_format:'':'',
            'folio_cotizacion' => (string)$model->cotizacion?$model->cotizacion->numero_folio_format:'',
