...
class ReembolsoGastoSolTransformer extends TransformerAbstract
{
    /**
    ...
    public function transform(ReembolsoGastoSol $model){
        return [
            'id' => $model->getKey(),
     ...
     */
    public function includeDocumentos(ReembolsoGastoSol $model)
    {
