...
namespace App\Repositories\CADECO\Finanzas\RegistrarPago;
...
class Repository implements RepositoryInterface
{
    ...
    {
        $empresa = $this->all();
        $ids = $empresa->pluck('id_empresa')->toArray();
        return Empresa::query()->whereIn('id_empresa', array_unique($ids))->orderBy('razon_social', 'ASC')->get();
    }

    public function pendientesPago($id){
        $this->scope();
        $this->where([['id_empresa', '=', $id]]);
        $query = $this->model;
