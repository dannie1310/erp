...
class SolicitudAutorizacionAvanceLayout implements WithHeadings, ShouldAutoSize, WithEvents
{
    ...
    public function __construct($subcontrato, $partidas)
    {
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $i = 8;
                $verificacion_estimacion = $this->verifica->encripta($this->subcontrato['base']."|".$this->subcontrato['id_obra']."|".$this->subcontrato['id']);
                ...
                $event->sheet->setCellValue("D" . ($i+3), $this->subcontrato['observaciones']);
    ...
    {
        return array([' ','',' ',' ',' ',' ',' ',($this->subcontrato['empresa']) ? $this->subcontrato['empresa'] : '----- Proveedor Desconocido ----- '],[],[],[],[],[],[],
