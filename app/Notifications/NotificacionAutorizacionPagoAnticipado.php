...
class NotificacionAutorizacionPagoAnticipado extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject("Autorización de Pago Anticipado " . $this->solicitud_pago_anticipado->numero_folio_format . " (".$this->solicitud_pago_anticipado->obra->nombre.")")
            ->view('emails.autorizacion_pago_anticipado',[
