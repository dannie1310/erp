        ...
        if(17 == 17){
            if($carta_terminos){
                ...
                return (new MailMessage)
                    ->subject("Invitación a Cotizar")
                    ->view('emails.invitacion_cotizar',["invitacion"=>$this->invitacion])
                    ->attachData($pdf->Output("S","Invitación a Cotizar ".$this->invitacion->transaccionAntecedente->numero_folio.".pdf")
                        , 'Invitación a Cotizar '.$this->invitacion->transaccionAntecedente->numero_folio.'.pdf'
