...
class Material extends Model
{
    ...
    {
        $materiales =  Material::query()->join('inventarios', 'materiales.id_material', 'inventarios.id_material')->where('inventarios.id_almacen', $id)->pluck('materiales.id_material');
