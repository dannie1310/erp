...
class IncidenteMovimientoIndividualConsolidada extends Model
{
    protected $connection = 'seguridad';
    protected $table = 'SEGURIDAD_ERP.IncidentesPolizas.incidentes_movimientos_individual_consolidada';
