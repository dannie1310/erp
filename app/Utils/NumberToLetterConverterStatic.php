...
class NumberToLetterConverterStatic
{
    ...
    public static function Num2Ordinales(int $numero)
    {
        $ordinales = array("","primer","segundo","tercer","cuarto", "quinto", "sexto", "séptimo"
        ...
        if(key_exists($numero, $ordinales))
        {
