...
$api->version('v1', function ($api) {
    ...
    $api->group(['middleware' => 'api', 'prefix' => 'fiscal'], function ($api) {
        ...
        $api->group(['prefix' => 'proveedor-rep'], function ($api){
            ...
            $api->get('proveedores-rep-pendiente-xls', 'App\Http\Controllers\v1\SEGURIDAD_ERP\Fiscal\ProveedorREPController@descargaXLS');
    ...
    $api->group(['middleware' => 'api', 'prefix' => 'control-recursos'], function ($api) {
        ...
        $api->group(['prefix' => 'documento'], function ($api) {
            ...
            $api->get('{id}/correo', 'App\Http\Controllers\v1\CONTROLRECURSOS\DocumentoController@correo')->where(['id' => '[0-9]+']);
        });
        ...
        $api->group(['prefix' => 'solicitud-cheque'], function ($api) {
            ...
            $api->get('{id}/formato-reembolso', 'App\Http\Controllers\v1\CONTROLRECURSOS\SolicitudChequeController@pdfReembolso')->where(['id' => '[0-9]+']);
        });
        ...
        $api->group(['prefix' => 'tasa-iva'], function ($api) {
            $api->get('/', 'App\Http\Controllers\v1\CONTROLRECURSOS\TasaIvaController@index');
        });
